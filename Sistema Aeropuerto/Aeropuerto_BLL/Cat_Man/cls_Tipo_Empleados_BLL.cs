    ...
    public class cls_Tipo_Empleados_BLL
    {
        ...
        public void Modificar(ref cls_Tipo_Clientes_DAL OBJ_Tipo_Clientes_DAL)
        {
            try
            {
                ...
                OBJ_DataBase_DAL.dt_Parametros.Rows.Add("@IdTipoEmpleado", "1", OBJ_Tipo_Clientes_DAL.IIdTipoCliente);
                OBJ_DataBase_DAL.dt_Parametros.Rows.Add("@DescTipo", "2", OBJ_Tipo_Clientes_DAL.SDescripcion);
